module CustomModelNaming
  # Extracted from: https://coderwall.com/p/yijmuq
  # This will help with STI naming as SubscriptionProduct inherits directly from
  # Spree Product, and all the routes helpers will fail
